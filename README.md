...
[![Container Repository on Quay](https://quay.io/repository/samdoran/fedora32-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/fedora31-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t fedora32-ansible -f Containerfile .
...
platforms:
  - name: role-test
    image: "quay.io/samdoran/${MOLECULE_DISTRIBUTION:-fedora32}-ansible:latest"
